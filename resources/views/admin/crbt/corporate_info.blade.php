    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Corporate Accounts</h4>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Corporate CRBT Accounts</h5>
                </div>
                <div class="card-body">
                    <p>Corporate accounts information will be displayed here.</p>
                    <!-- Add your corporate accounts content here -->
                </div>
            </div>
        </div>
    </div>
